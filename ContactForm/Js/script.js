...
function aguardandoCampos() {
    document.getElementById("rua").value = "Aguardando preenchimento do CEP...";
    document.getElementById("bairro").value = "Aguardando preenchimento do CEP...";
    document.getElementById("cidade").value = "Aguardando preenchimento do CEP...";
    document.getElementById("estado").value = "Aguardando preenchimento do CEP...";
}